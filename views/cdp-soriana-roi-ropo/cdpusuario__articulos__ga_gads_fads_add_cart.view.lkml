view: cdpusuario__articulos__ga_gads_fads_add_cart {
  sql_table_name: `costumer-data-proyect.customer_data_platform.cdp-usuario_ articulos _ga_gads_fads_add_cart`
    ;;

  dimension: articulos_anadido_carrito {
    type: string
    sql: ${TABLE}.articulosAnadidoCarrito ;;
  }
  ...
  dimension: conteo_articulos_anadido_carrito {
    type: number
    sql: ${TABLE}.conteoArticulosAnadidoCarrito ;;
  }
